...
$config = array(
    ...
    * The default is "install" - this is a keyword that stats the installation process
    * Once installation is complete, you can change
	 * this to a private uri found here https://members.cpabuild.com/privateURL (use the bold text in the "On Your Website" column).
	...
	*/
	...
	/*
	 * If you are using a CPABuild mirror from https://members.cpabuild.com/mirrors
	 * then add "bucket." as a prefix to the domain
	 * Example: bucket.bitsc.io
	 */
